...
module.exports = class NodeLogs {
	...
	// log
		...
		log (msg, options = []) {
			...
			return input(this._interfaces, msg, "log", options).then((message) => {
		...
		info (msg, options = []) {
			...
			return input(this._interfaces, msg, "information", options).then((message) => {
		...
		ok (msg, options = []) {
			...
			return input(this._interfaces, msg, "success", options).then((message) => {
		...
		warn (msg, options = []) {
			...
			return input(this._interfaces, msg, "warning", options).then((message) => {
		...
		err (msg, options = []) {
			...
			return input(this._interfaces, msg, "error", options).then((message) => {
