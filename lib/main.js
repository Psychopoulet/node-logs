...
module.exports = class NodeLogs {
	...
	// log
		...
		log (message, options = []) {
			...
			return (this._showInConsole ? _console(msg, [ "log", ...options ]) : Promise.resolve()).then(() => {
		...
		info (message, options = []) {
			...
			return (this._showInConsole ? _console(msg, [ "information", ...options ]) : Promise.resolve()).then(() => {
		...
		ok (message, options = []) {
			...
			return (this._showInConsole ? _console(msg, [ "success", ...options ]) : Promise.resolve()).then(() => {
		...
		warn (message, options = []) {
			...
			return (this._showInConsole ? _console(msg, [ "warning", ...options ]) : Promise.resolve()).then(() => {
		...
		err (message, options = []) {
			...
			return (this._showInConsole ? _console(msg, [ "error", ...options ]) : Promise.resolve()).then(() => {
