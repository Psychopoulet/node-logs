...
module.exports = class NodeLogs {
	...
	// accessors
		...
		deleteLogsAfterXDays(deleteLogsAfterXDays) {
			this._deleteLogsAfterXDays = ("number" === typeof deleteLogsAfterXDays) ? deleteLogsAfterXDays : this.deleteLogsAfterXDays; return this;
		}

		localStorageDatabase(localStorageDatabase) {
			this._localStorageDatabase = ("string" === typeof localStorageDatabase) ? localStorageDatabase : this.localStorageDatabase; return this;
		}

		showInConsole(showInConsole) {
			this._showInConsole = ("boolean" === typeof showInConsole) ? showInConsole : this._showInConsole; return this;
		}
