...
// deps
	...
	const formateDateTime = require(join(__dirname, "formateDateTime.js"));
		...
		log (msg, options = null) {
			...
			if (this._showInConsole) {
				...
				if ("string" === typeof msg && "" === msg.trim()) {
					...
					(0, console).log(formateDateTime(new Date()), msg);
				}
		...
		ok (msg, options = null) {
			...
			if (this._showInConsole) {
				...
				if ("string" === typeof msg && "" === msg.trim()) {
					...
					(0, console).log(formateDateTime(new Date()), colors.green(msg));
				}
		...
		warn (msg, options = null) {
			...
			if (this._showInConsole) {
				...
				if ("string" === typeof msg && "" === msg.trim()) {
					...
					(0, console).log(formateDateTime(new Date()), colors.yellow(msg));
				}
		...
		err (msg, options = null) {
			...
			if (this._showInConsole) {
				...
				if ("string" === typeof msg && "" === msg.trim()) {
					...
					(0, console).log(formateDateTime(new Date()), colors.red(msg));
				}
		...
		info (msg, options = null) {
			...
			if (this._showInConsole) {
				...
				if ("string" === typeof msg && "" === msg.trim()) {
					...
					(0, console).log(formateDateTime(new Date()), colors.cyan(msg));
				}
