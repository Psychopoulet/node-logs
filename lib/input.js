...
// private
	...
	// methods
		...
		*/
		function _inputInterfaces (interfaces, i, msg, type, options = null) {
...
module.exports = (interfaces, message, type, options = null) => {
	...
	if ("undefined" === typeof interfaces) {
		...
		return _inputInterfaces(interfaces, 0, "object" === typeof message ? JSON.stringify(message) : message, type, options);
	}
