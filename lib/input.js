...
// consts
	...
	const OPTIONS = [ "background", "bold", "italic", "underline" ];
...
module.exports = (interfaces, msg, type, options = []) => {
	...
	if ("undefined" === typeof interfaces) {
		...
		return Promise.resolve().then(() => {
			...
			const message = "object" === typeof msg ? JSON.stringify(msg) : msg;

			return _inputInterfaces(interfaces, 0, message, type, options.filter((option) => {
